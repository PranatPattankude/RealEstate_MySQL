...
import { UserContext } from "../UserPanel/UserContext/userContext";
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userInfo.role == "admin") {
        ...
        navigate("/UserHome");
      } else if (userInfo.role == "auth_seller") {
        navigate("/SellerHome");
      } else if (userInfo.role == "unauth_seller") {
        alert("your Request is Not Approved");
      } else {
    ...
    <>
      <div className="d-md-flex backgroundColor vw-100  vh-100">
        <div className="col-12 col-lg-6  h-100 d-flex justify-content-center align-items-center">
          <form
            className="form w-50 d-flex flex-column"
