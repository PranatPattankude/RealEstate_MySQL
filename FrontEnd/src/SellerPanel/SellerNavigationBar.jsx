            ...
            <div className="container">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto d-flex align-items-center gap-3">
                        <Nav.Link as={Link} to="/SellerHome/SellerAddProperty" className="text-dark">Add Property</Nav.Link>
                        {/* <Nav.Link as={Link} to="/AdminHome/AddProduct" className="text-dark">Add Property</Nav.Link> */}
                        <Nav.Link as={Link} to="/SellerHome/SellerPropertyStatus" className="text-dark">Proppery Status</Nav.Link>
                        {/* <Nav.Link as={Link} to="/SellerHome/Users" className="text-dark">Users</Nav.Link> */}
                        {/* <Nav.Link as={Link} to="/SellerHome/Sellers" className="text-dark">Sellers</Nav.Link> */}
                      
                        <Nav.Link as={Link} to="/SellerHome/Profile" className="text-dark">{user.role=="auth_seller"&&"Seller"} : {user.name}</Nav.Link>
